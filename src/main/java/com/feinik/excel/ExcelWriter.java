...
import com.feinik.excel.write.ExcelBuilder;
import com.feinik.excel.write.ExcelBuilderImpl;
...
public class ExcelWriter {
    ...
    public ExcelWriter write(List<? extends BaseRowModel> data, Sheet sheet, boolean needHead) {
        excelBuilder.getContext().setNeedHead(needHead);
        excelBuilder.addContent(data, sheet);
        return this;
    }
